...
def test_admissible(create_matrix):
    ...
    print_bar_graph(
        ...
        ["A* (colores)", "A* (distancia)", "IDDFS", "BFS"],
        "tiempo_admisible.png",
    )
    print_bar_graph(
        y,
        "Nodos expandidos",
    ...
    print_bar_graph(
        ...
        "Tiempo promedio (en ms)",
        ["A* (colores)", "A* (distancia)", "IDDFS", "BFS"],
        "tiempo_admisible_t.png",
    )
    print_bar_graph(
        y,
        "Nodos expandidos",
        ["A* (colores)", "A* (distancia)", "IDDFS", "BFS"],
        "nodos_admisible_t.png",
    )
    ...
    print_bar_graph(
        x,
        "Tiempo promedio (en ms)",
        ["A* (cantidad)", "DFS", "Greedy"],
        "tiempo_no_admisible.png",
    )
    print_bar_graph(
        y,
        "Nodos expandidos",
        ["A* (cantidad)", "DFS", "Greedy"],
        "nodos_no_admisible.png",
    )
    ...
    print_bar_graph(
        ...
        "Tiempo promedio (en ms)",
        ["A* (cantidad)", "DFS", "Greedy"],
        "tiempo_no_admisible_t.png",
    )
    print_bar_graph(
        y,
        "Nodos expandidos",
        ["A* (cantidad)", "DFS", "Greedy"],
        "nodos_no_admisible_t.png",
    )
...
def print_bar_graph(val, title, x_names, fig_name):
    ...
    for i in range(0, len(x_names)):
        mean.append(
            np.mean(np.array([val[0][i], val[1][i], val[2][i], val[3][i], val[4][i]]))
        )
        std.append(
            np.std(np.array([val[0][i], val[1][i], val[2][i], val[3][i], val[4][i]]))
        )
